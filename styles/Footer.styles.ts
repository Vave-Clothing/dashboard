...
import { BREAKPOINT as MDX_PAGE_BREAKPOINT } from '@/styles/PageHeader.styles'
...
// Styles borrowed from https://github.com/mantinedev/mantine/blob/master/docs/src/components/Footer/Footer.styles.ts
// License: MIT